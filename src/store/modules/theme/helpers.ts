...
import { getThemeColor, getColorPalette, addColorAlpha } from '@/utils'; // 工具 （获取主题颜色，获取颜色调色板， 添加颜色透明）getColorPalette, addColorAlpha
...
/** 获取element-plus的主题颜色 */
export function getElementThemeOverrides(colors: Record<ColorType, string>): ElTheme.GlobalThemeOverrides {
...
type ThemeVars = Exclude<ElTheme.GlobalThemeOverrides['common'], undefined>;
