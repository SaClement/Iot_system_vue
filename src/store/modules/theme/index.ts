...
import { getThemeSettings, getElementThemeOverrides, addThemeCssVarsToHtml } from './helpers';
...
export const useThemeStore = defineStore('theme-store', {
  ...
  getters: {
    ...
    naiveThemeOverrides(state) {
      const overrides = getElementThemeOverrides({ primary: state.themeColor, ...state.otherColor });
    ...
    naiveTheme(state) {
      ...
      return state.darkMode ? toggleDark : undefined;
    }
  },
  actions: {
    /** 重置theme状态 */
