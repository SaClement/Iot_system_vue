...
import type { AxiosRequestConfig, AxiosInstance, AxiosError } from 'axios'; // axios (请求配置，请求超时，请求错误)
import { REQUEST_TIMEOUT, REFRESH_TOKEN_CODE } from '@/config'; // 配置（请求超时， 刷新token）
import {
  getToken,
