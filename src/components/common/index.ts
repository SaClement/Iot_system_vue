...
import Verifition from './Verifition/index.vue';

// export { ElementProvider, SystemLogo, DarkModeSwitch, DarkModeContainer, HoverContainer };
export { SystemLogo, DarkModeContainer, HoverContainer, Verifition };